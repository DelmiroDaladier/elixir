defmodule Wizard.CollectionExercise do
  ...
  """
  def remove() do
    items = ["Carbon", "Hydrogen", "Ruthenium", "Silicon"]
    List.delete(items, "Carbon")
  end
  ...
  * Cabbage and Casting, by Cilka Parfait, 1975
  ...
  def books() do
    ...
    book2 = %{title: "Livro 2", author: "Autor 2", year: 1990}
    book3 = %{title: "Livro 3", author: "Autor 3", year: 1990}
    [book1, book2, book3]
  end
